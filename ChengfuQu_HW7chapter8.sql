...
INSERT INTO dbo.Customers (custid, companyname, country, region, city)
SELECT DISTINCT sc.custid, companyname, country, region, city
...
DROP TABLE IF EXISTS dbo.Orders;
		SELECT orderid, orderdate, empid, custid, shipcountry, shipcity,shipregion
		INTO dbo.Orders
...
SET shipcountry = country, 
	...
	FROM dbo.Customers JOIN dbo.Orders
		ON dbo.Orders.custid = dbo.Customers.custid
